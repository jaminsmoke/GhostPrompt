...
| **FW–GB** | Superficies chat (sidebar) + hub (panel); fin paridad dual chat | En curso — **FW–GA** hechos; pendiente **GB** (QA); ver [05-dual-surface-chat-hub.md](./05-dual-surface-chat-hub.md) |
