...
| **FW–GB** | Superficies chat (sidebar) + hub (panel); fin paridad dual chat | **Completado** — ver [05-dual-surface-chat-hub.md](./05-dual-surface-chat-hub.md) (GB: checklist + bitácora; smoke EDH al release) |
