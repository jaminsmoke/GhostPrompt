...
| Fase 7 | **Optimistic updates + placeholder modelo + args optimizados** | Al seleccionar modelo → "Iniciando" inmediato. Al cambiar a Ollama → reset modelo. `--keepalive 5m` | ⚪ No iniciado |
...
| Hito 7 | **Optimistic updates + placeholder + args** | "Iniciando" inmediato, reset modelo al cambiar, --keepalive 5m | ⚪ No iniciado |
