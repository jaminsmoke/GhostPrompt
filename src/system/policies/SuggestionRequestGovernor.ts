 ...
 * @param {string} text Texto original de la solicitud.
 * @returns {string} Cadena trimmed, con espacios colapsados y en minúsculas.
 */
 ...
 * @param {string} normalizedInput Texto ya normalizado.
 * @param {GovernorRequestScope | undefined} scope Alcance opcional de la solicitud para diferenciar la clave.
 * @returns {string} Clave compuesta que incorpora scope y texto.
 */
 ...
 * @param {string | undefined} value Valor de scope opcional.
 * @returns {string} Cadena limpia en minúsculas o vacía si no existe valor.
 */
 ...
 * @param {number} value Valor original a ajustar.
 * @param {number} min Límite inferior permitido.
 * @param {number} max Límite superior permitido.
 * @returns {number} Valor entero ajustado dentro del rango.
 */
