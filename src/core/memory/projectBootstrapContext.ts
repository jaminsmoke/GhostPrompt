 ...
 * @param {Uint8Array} data Datos binarios a hashear.
 ...
 * @param {string} text Texto original a truncar.
 * @param {number} maxChars Límite máximo de caracteres UTF-16.
 ...
 * @param {string} jsonText Contenido JSON de package.json.
 ...
 * @param {readonly string[]} lines Líneas de texto que representan el card de bootstrap.
...
/**
 * Resuelve la carpeta del workspace que usa GhostPrompt para bootstrap.
 * Prioriza el editor activo y, si no existe, la primera carpeta del workspace.
 * @returns {vscode.Uri | undefined} URI de la carpeta de raíz del workspace, o undefined si no hay workspace.
 */
 ...
 * README* aparece antes de package.json y el resto se ordena alfabéticamente.
 * @param {readonly ProjectBootstrapPiece[]} pieces Fragmentos de bootstrap a ordenar.
 * @returns {ProjectBootstrapPiece[]} Nuevos fragmentos ordenados.
 */
 ...
 * 1 = archivos README, 2 = package.json, 0 = otros.
 * @param {string} rel Ruta relativa a clasificar.
 ...
 * @param {vscode.Uri | undefined} root URI opcional de la raíz del workspace.
