/**
 * Tipos y opciones compartidos del dominio suggestion (completion, contexto, políticas).
 * Ruta canónica: `core/types`.
 */
import type { CancellationToken } from 'vscode';

import type { SuggestionLoadingPhase } from './presentation/loading';
