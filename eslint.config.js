          ...
          zones: [
            {
              ...
              message:
                'core/memory no debe importar desde ui/provider, ui/notifications ni api. Ver Docs/Owners.md.',
            },
            {
              target: './src/system/debug/**/*',
              from: ['./src/ui/provider/**/*', './src/ui/notifications/**/*', './src/api/**/*'],
              message:
                'debug no debe importar desde ui/provider, ui/notifications ni api. Ver Docs/Owners.md fase D.',
            },
          ],
        },
      ],
